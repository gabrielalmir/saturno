...
/**
* @see \App\Http\Controllers\IntegrationController::syncNow
* @see app/Http/Controllers/IntegrationController.php:68
* @route '/settings/integrations/{integration}/sync-now'
*/
export const syncNow = (args: { integration: number | { id: number } } | [integration: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/settings/integrations/{integration}/sync-now'
*/
syncNow.url = (args: { integration: number | { id: number } } | [integration: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { integration: args }
    }
...
* @route '/settings/integrations/{integration}/sync-now'
*/
syncNow.post = (args: { integration: number | { id: number } } | [integration: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: syncNow.url(args, options),
    method: 'post',
})
...
* @route '/settings/integrations/{integration}/sync-now'
*/
const syncNowForm = (args: { integration: number | { id: number } } | [integration: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/settings/integrations/{integration}/sync-now'
*/
syncNowForm.post = (args: { integration: number | { id: number } } | [integration: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: syncNow.url(args, options),
    method: 'post',
})
...
const IntegrationController = { index, store, update, test, syncNow, toggle, links, destroy }
