        ...
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-500/10 via-[#0B0D13] to-purple-500/10 p-8 shadow-[0_30px_120px_rgba(76,29,149,0.22)] md:p-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-relaxed text-slate-300 md:text-lg">
              Acreditamos que equipes extraordinárias precisam de clareza, não
              de burocracia. Saturno nasce para ser a camada de coordenação que
              transforma estratégia em entregas consistentes — com
              transparência, autonomia e responsabilidade compartilhada.
            </p>
          </div>
