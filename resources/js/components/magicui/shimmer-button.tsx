...
export function ShimmerButton({
    ...
    const baseClassName = cn(
        'group relative z-0 inline-flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap [border-radius:var(--radius)] border border-white/10 px-6 py-3 text-white [background:var(--bg)]',
