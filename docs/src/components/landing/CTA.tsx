		...
		>
			...
			<div className="relative z-10 mx-auto max-w-3xl space-y-8">
				...
				<p className="text-xl text-slate-400">
					Saturno é open source e gratuito para sempre. Contribua, customize e
					self-host sem limitações.
				</p>
				<div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
					...
					<a href="/docs/">
						<Button
							size="lg"
							variant="ghost"
							className="h-14 min-h-14 rounded-full px-8 text-lg font-medium text-slate-400 hover:bg-white/5 hover:text-white"
						>
